...
const FuturisticMetricCard = ({
  ...
  >
      ...
      {trend !== undefined && (
        <div className="flex items-center gap-2 bg-background/40 backdrop-blur-sm w-fit px-2 py-1 rounded-lg border border-white/5">
          <span
            className={
              trend >= 0
                ? 'text-success flex items-center text-xs font-bold'
                : 'text-destructive flex items-center text-xs font-bold'
            }
          >
            {trend >= 0 ? (
    ...
    <div
      className="absolute -bottom-10 -left-10 w-32 h-32 blur-[60px] rounded-full opacity-20 transition-all duration-500 group-hover:opacity-40"
      style={{ backgroundColor: glowColor }}
    />
  </div>
);
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1 uppercase tracking-wider">
                  Projeção preditiva baseada em histórico de 12 meses
                </p>
              </div>
              ...
              <AreaChart data={evolucaoMensal}>
                <defs>
                  ...
                  <linearGradient id="colorLucro" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="var(--ok)" stopOpacity={0.2} />
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] font-bold text-success">
                    +{((item.receitas / 10000) * 10).toFixed(1)}%
                  </p>
                </div>
              </div>
            ))}
