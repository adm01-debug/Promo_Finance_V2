    ...
    <div ref={ref}>
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full gap-3 rounded-xl h-12 border-border/50 bg-background/50 hover:bg-background hover:border-primary/30 transition-all duration-300 shadow-sm active:scale-[0.98]"
        ...
        {biometricAvailable && (
          <>
            <Button
              type="button"
              variant="outline"
              className="w-full gap-2 rounded-xl h-11 border-border/50 bg-background/50 hover:bg-background transition-all duration-300"
