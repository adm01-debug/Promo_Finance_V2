            ...
            >
              <CardHeader className="p-5 pb-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] font-black border-white/10 bg-card/5 rounded-md px-2 py-0.5"
                  >
                    {items.length}
                  </Badge>
                </div>
                        ...
                        <div className="relative z-10">
                          <div className="flex justify-between items-start gap-2">
                            ...
                            {overdueDays > 0 && col.id !== 'pago' && (
                              <Badge
                                variant="destructive"
                                className="text-[8px] font-black px-1.5 py-0 rounded-md border-none bg-destructive/20 text-destructive animate-pulse"
                              >
                                {overdueDays}d em atraso
                              </Badge>
                            )}
                          </div>
                          <p className="text-[10px] font-semibold text-muted-foreground/60 truncate mt-1 leading-none">
                            {conta.descricao}
                          </p>

                          <div className="mt-4 flex items-center justify-between">
                            <span className="text-base font-black tabular-nums tracking-tighter text-foreground">
