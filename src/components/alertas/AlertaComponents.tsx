...
import { Calendar, Users, Clock, Eye, ArrowRight, Loader2, ShieldCheck, BellOff, Activity } from 'lucide-react';
...
import { prioridadeConfig, tipoConfig } from './alerta-components.config';
