        ...
        <Card className="bg-amber-50/30 border-amber-200/50">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-amber-800">Boletos em Aberto</p>
                <p className="text-2xl font-bold text-amber-900">{boletosAbertos}</p>
              </div>
            </div>
            <div className="text-right">
              <Badge variant="outline" className="bg-amber-100/50 text-amber-700 border-amber-200">Aguardando Pagamento</Badge>
            </div>
          </CardContent>
        </Card>

        <Card className="bg-rose-50/30 border-rose-200/50">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-rose-800">Divergências de Conciliação</p>
                <p className="text-2xl font-bold text-rose-900">{divergenciasPendentes}</p>
              </div>
            </div>
            <div className="text-right">
              <Badge variant="outline" className={cn("bg-rose-100/50 text-rose-700 border-rose-200", divergenciasPendentes > 0 ? "animate-pulse" : "")}>
                {divergenciasPendentes > 0 ? 'Ação Necessária' : 'Tudo Conciliado'}
              </Badge>
            </div>
          </CardContent>
        </Card>
