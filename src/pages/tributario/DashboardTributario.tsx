          ...
          >
            <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
              <Select value={empresaId} onValueChange={setEmpresaId}>
                <SelectTrigger className="w-full sm:w-64 h-10 rounded-xl bg-background/40">
  ...
  return (
    <Card className="backdrop-blur-xl bg-background/40 border-white/10 hover-scale transition-all shadow-xl">
      ...
      <CardContent>
        ...
        <p className="text-[10px] text-muted-foreground/60 mt-1 truncate font-medium">{hint}</p>
      </CardContent>
    </Card>
  );
}
