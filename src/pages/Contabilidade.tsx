...
import { BookOpen, FileText, Calculator, Building2, BookText, BarChart3, AlertTriangle, Plug } from 'lucide-react';
...
const VALID_TABS = ['plano', 'lancamentos', 'razao', 'dre', 'integracoes', 'ecd', 'ecf'] as const;
