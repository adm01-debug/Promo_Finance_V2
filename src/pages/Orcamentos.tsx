...
const Orcamentos = () => {
  ...
  if (isLoading)
    return (
      <MainLayout>
        <div className="p-8">Carregando orçamentos...</div>
      </MainLayout>
    );
            ...
            <Card className="bg-card/5 border-border backdrop-blur-xl">
              <CardContent className="pt-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] uppercase border-blue-500/30 text-blue-500"
                  >
                    Total Orçado
                  </Badge>
                </div>
            ...
            <Card className="bg-card/5 border-border backdrop-blur-xl">
              <CardContent className="pt-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] uppercase border-orange-500/30 text-orange-500"
                  >
                    Total Gasto
                  </Badge>
                </div>
                ...
                <p className="text-xs text-foreground/40 mt-1">
                  {totals.percent.toFixed(1)}% do orçamento consumido
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/5 border-border backdrop-blur-xl">
              <CardContent className="pt-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] uppercase border-green-500/30 text-green-500"
                  >
                    Restante
                  </Badge>
                </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="bg-card/5 border-border backdrop-blur-xl">
                <CardHeader>
                  ...
                  <CardDescription>
                    Acompanhe o status de cada categoria individualmente.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {budgets.length === 0 ? (
                      ...
                      budgets.map((budget) => {
                        ...
                        return (
                          <div
                            key={budget.id}
                            className="group p-4 rounded-2xl bg-card/5 border border-white/5 hover:border-border transition-all"
                          >
                              ...
                              <div>
                                <h4 className="font-bold text-foreground flex items-center gap-2">
                                  ...
                                  {budget.percent_used > 90 && (
                                    <AlertTriangle
                                      className={`h-4 w-4 ${textColor} animate-pulse`}
                                    />
                                  )}
                                </h4>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-3">
                              <div>
                                <p className="text-[10px] uppercase text-foreground/40 font-bold mb-1">
                                  Orçado
                                </p>
                            ...
                            <Progress
                              ...
                              className={`h-1.5 bg-card/10 ${statusColor}`}
                            />
                          </div>
                        );
                      })
              ...
              <Card className="bg-primary/5 border-primary/20 backdrop-blur-xl border-dashed">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Com base nos lançamentos atuais, você já consumiu{' '}
                    <strong>{totals.percent.toFixed(1)}%</strong> do orçamento total.
                    {totals.percent > 90
                      ? ' Recomendamos cautela nos próximos lançamentos para evitar estouro orçamentário.'
                      : ' O ritmo de gastos está dentro do esperado para o período.'}
                  </p>
                </CardContent>
              </Card>
            </div>
