...
const colorThemes: Record<string, string[]> = {
  ...
  gold: ['#f7b84e', '#e0a43a', '#ffc66e', '#d9972f'],
  celebration: ['#7c5cff', '#9d86ff', '#b9a3ff', '#f76d7d', '#e05a68'],
  money: ['#33d493', '#2bb881', '#5ce0ad', '#f7b84e', '#e0a43a'],
  rainbow: ['#f76d7d', '#f7b84e', '#33d493', '#56a8ff', '#7c5cff', '#9d86ff'],
};
