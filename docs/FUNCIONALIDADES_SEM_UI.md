...
| ----------------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api-keys-manage` | `src/hooks/useApiKeys.ts` → página `/admin/api` | **Implementada no repositório em 2026-09-10; requer deploy da Edge Function.** Cria credencial de 256 bits, persiste somente SHA-256, exige admin com vínculo ativo à empresa e devolve o segredo uma única vez. A autenticação de APIs externas continua dependente de endpoint específico por integração; não existe API pública genérica. |
