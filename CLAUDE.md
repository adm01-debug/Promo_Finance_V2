...
| Migrations | 551+ (timestamp YYYYMMDDHHmmss) |
| Tabelas | 130+ |
...
## 3. Edge Functions (51 funcoes Deno)

- **Financeiro:** categorizar-despesa, conciliacao-ia, executar-regua-cobranca, processar-fila-cobrancas
- **Tributario:** calcular-iva, decidir-regime, executar-fechamento-tributario, gerar-dre-tributaria, gerar-sped-ecd, gerar-sped-ecf, simular-presumido, simular-real, simular-simples, verificar-conformidade-fiscal
...
```
Meta: 1012/1012 testes passando, 0 erros TypeScript.
