...
-- As 6 views abaixo (contas_pagar/receber_painel, dre_mensal, dso_aging,
-- gastos_centro_custo, fluxo_caixa) podem não existir aqui: os guards de
-- 20260317125441 pulam a criação quando as colunas de que dependem ainda não
-- existem (só adicionadas entre 20260518164611 e 20260519160631). ALTER VIEW
-- sobre relação inexistente quebraria o replay do zero (achado PR #63).
DO $$
BEGIN
