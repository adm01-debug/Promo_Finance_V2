...
-- `conciliacao_bancaria` não faz parte do replay canônico atual. Preservamos a
-- migration sem falhar o preview.
DO $legacy_conciliacao_index$
BEGIN
  IF EXISTS (
    SELECT 1
