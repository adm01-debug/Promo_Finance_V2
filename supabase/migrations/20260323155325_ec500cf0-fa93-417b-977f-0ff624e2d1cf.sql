-- vw_contas_pagar_painel/vw_contas_receber_painel podem não existir aqui pelo
-- mesmo motivo de 20260317125502 (guard de 20260317125441 sobre conta_bancaria_id).
DO $$
BEGIN
