...
DROP FUNCTION IF EXISTS public.faixa_simples_reparticao_valida(jsonb) CASCADE;
...
EXCEPTION WHEN duplicate_object OR undefined_table OR undefined_column OR undefined_function THEN NULL;
END $c2faixas$;
