...
Deno.test(
  'executar-analise-preditiva rejeita chamada sem credencial antes de acessar serviços',
  async () => {
...
Deno.test(
  'executar-analise-preditiva rejeita segredo interno incorreto antes de acessar serviços',
  async () => {
    const response = await executarSemRede(
      new Request('http://localhost/executar-analise-preditiva', {
        method: 'POST',
