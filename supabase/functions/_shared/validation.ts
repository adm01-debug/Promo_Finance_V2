...
export const AsaasWebhookSchema = z
  ...
  .strict();
export const AsaasWebhookV2Schema = AsaasWebhookSchema.extend({
...
export const BlingWebhookSchema = z
  ...
  .strict();
export const BlingWebhookV2Schema = BlingWebhookSchema.extend({
  eventId: z.string().trim().min(1),
}).strict();

export const Bitrix24WebhookSchema = z
  .object({
    event: z.string(),
    data: z.object({
  ...
  .strict();
export const Bitrix24WebhookV2Schema = Bitrix24WebhookSchema.extend({
  event_id: z.string().trim().min(1),
}).strict();

export const AsaasProxySchema = z
  .object({
    action: z.string(),
...
export const BlingProxySchema = z
  .object({
    action: z.string(),
  })
  .passthrough();
...
export const WhatsappWebhookSchema = z
  ...
  .strict();
export const WhatsappWebhookV2Schema = WhatsappWebhookSchema.extend({
  messageId: z.string().trim().min(1),
}).strict();

export const CnpjaLookupSchema = z
  .object({
    cnpj: z.string().min(14),
  })
  .strict();

export const EnviarAlertaEmailSchema = z
  .object({
...
export const OptionalEmpresaIdSchema = z
  .object({
    empresa_id: z.string().uuid().optional().nullable(),
  })
  .strict();

export const BenchmarkingSetorialSchema = z
  .object({
...
export const Bitrix24SyncSchema = z
  .object({
    action: z.enum([
      'sync_deals',
      'sync_deals_all',
...
export const ContabilizarEventoSchema = z
  .object({
...
export const ExecutarRelatoriosSchema = z
  .object({
    relatorio_id: z.string().uuid().optional().nullable(),
  })
  .strict();

export const WhatsappIaProativoSchema = z
  .object({
...
export const CalculoIvaSchema = z
  .object({
...
export const CategorizarDespesaSchema = z
  .object({
    despesas: z.array(
      z.object({
        id: z.string().optional(),
...
export const ParametrosSimulacaoSchema = z
  .object({
...
export const SimularSimplesRpcSchema = z
  .object({
    faturamentoAnual: z.number().nonnegative(),
...
export const DecidirRegimeSchema = z
  .object({
...
export const ProjecaoReformaSchema = z
  .object({
    faturamentoAnual: z.number().nonnegative(),
    setor: z.string().optional(),
...
export const PreverCargaSchema = z
  .object({
    empresa_id: z.string().uuid().optional().nullable(),
